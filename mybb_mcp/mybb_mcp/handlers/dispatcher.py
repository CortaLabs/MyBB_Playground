...
from .orchestration import ORCHESTRATION_HANDLERS
from .plugins import PLUGIN_HANDLERS
from .workspace_git import WORKSPACE_GIT_HANDLERS
from .languages import LANGUAGE_HANDLERS
...
HANDLER_REGISTRY.update(ORCHESTRATION_HANDLERS)
HANDLER_REGISTRY.update(PLUGIN_HANDLERS)
HANDLER_REGISTRY.update(WORKSPACE_GIT_HANDLERS)
HANDLER_REGISTRY.update(LANGUAGE_HANDLERS)
