...
# 🐞 Bug Log — mybb_mcp_phase3a_tests
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: mybb_mcp_phase3a_tests] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
