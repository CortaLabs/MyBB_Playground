...
# 🔒 Security Log — mybb_sync_safeguards
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: mybb_sync_safeguards] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
