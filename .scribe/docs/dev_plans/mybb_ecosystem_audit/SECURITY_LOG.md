...
# 🔒 Security Log — mybb-ecosystem-audit
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: mybb-ecosystem-audit] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
