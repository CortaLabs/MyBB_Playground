...
# 🔒 Security Log — plugin_manager_db_fix
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: plugin_manager_db_fix] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
