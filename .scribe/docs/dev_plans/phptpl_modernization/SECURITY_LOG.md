...
# 🔒 Security Log — phptpl-modernization
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: phptpl-modernization] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
