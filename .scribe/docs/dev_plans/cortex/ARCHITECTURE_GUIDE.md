...
# 🏗️ Architecture Guide — cortex
**Author:** Scribe
**Version:** Draft v0.1
**Status:** Draft
**Last Updated:** 2026-01-18 11:07:01 UTC

> Architecture guide for cortex.

---
## 1. Problem Statement
<!-- ID: problem_statement -->
- **Context:** cortex needs a reliable documentation system.
- **Goals:**
...
```
/home/austin/projects/MCP_SPINE/scribe_mcp/docs/dev_plans/cortex
```
