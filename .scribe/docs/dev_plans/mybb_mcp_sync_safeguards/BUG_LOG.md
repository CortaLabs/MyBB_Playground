...
# 🐞 Bug Log — mybb-mcp-sync-safeguards
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: mybb-mcp-sync-safeguards] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
