...
# 🔒 Security Log — mybb_cache_refresh_research
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: mybb_cache_refresh_research] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
