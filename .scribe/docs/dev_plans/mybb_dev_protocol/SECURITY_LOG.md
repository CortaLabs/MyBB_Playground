...
# 🔒 Security Log — mybb-dev-protocol
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: mybb-dev-protocol] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
