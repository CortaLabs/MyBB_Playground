...
# 📋 Documentation Update Log — cortex-audit
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: cortex-audit] Message text | doc=<doc_name>; section=<section_id>; action=<action_type>; [additional metadata]
```
