...
# 🔒 Security Log — private-plugin-infra
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: private-plugin-infra] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
