...
# 🔒 Security Log — mybb_theme_research
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: mybb_theme_research] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
