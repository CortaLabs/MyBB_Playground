...
# 🔒 Security Log — plugin-theme-manager
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: plugin-theme-manager] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
