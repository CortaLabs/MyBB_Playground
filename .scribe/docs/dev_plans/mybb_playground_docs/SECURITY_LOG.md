...
# 🔒 Security Log — mybb-playground-docs
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: mybb-playground-docs] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
