...
# 🐞 Bug Log — template-deployment-research
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: template-deployment-research] Message text | severity=<severity>; component=<component>; status=<status>; [additional metadata]
```
