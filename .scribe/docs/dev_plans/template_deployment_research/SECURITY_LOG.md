...
# 🔒 Security Log — template-deployment-research
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: template-deployment-research] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
