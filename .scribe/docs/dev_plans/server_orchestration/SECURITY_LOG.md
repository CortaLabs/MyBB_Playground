...
# 🔒 Security Log — server-orchestration
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: server-orchestration] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
