...
# 🔒 Security Log — mybb-sync-safeguards
...
## Entry Format
```
[EMOJI] [YYYY-MM-DD HH:MM:SS UTC] [Agent: <name>] [Project: mybb-sync-safeguards] Message text | severity=<severity>; area=<area>; impact=<impact>; [additional metadata]
```
